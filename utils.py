...
# import csv
#
# def gen_preds2(edges_pos, edges_neg, adj_rec):
#     preds = []
#     for e in edges_pos:
#         preds.append(adj_rec[e[0], e[1]])
#
#     with open('pre_neg.csv', 'w', encoding='utf8', newline='') as f:
#         writer = csv.writer(f)
#
#         # 写入表头
#         writer.writerow(['Drug Pair', 'Prediction Value'])
#
#         preds_neg = []
#         for e in edges_neg:
#             pred_value = adj_rec[e[0], e[1]]
#             preds_neg.append(pred_value)
#
#             # 写入每对药物及其预测值
#             writer.writerow([f'({e[0]}, {e[1]})', pred_value])
#
#
#     return preds, preds_neg
